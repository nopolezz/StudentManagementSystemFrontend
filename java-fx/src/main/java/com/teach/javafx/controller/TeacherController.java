...
public class TeacherController extends ToolController {
    ...
    @FXML
    private TableColumn<Map, String> degreeColumn; //学生信息表 专业 学位列
    @FXML
    private TableColumn<Map, String> authNumColumn; //学生信息表 班级列
    @FXML
    ...
    @FXML
    private TextField authNumField; //学生信息  班级输入域
    @FXML
    ...
    public void initialize() {
        ...
        authNumColumn.setCellValueFactory(new MapValueFactory<>("courseTaught"));
    ...
    protected void changeStudentInfo() {
        ...
        authNumField.setText(CommonMethod.getString(form, "courseTaught"));
    ...
    protected void onSaveButtonClick() {
        ...
        form.put("courseTaught", authNumField.getText());
